...
object Versions {
    ...
    object Deps {
        ...
        object Koin {
            const val core = "io.insert-koin:koin-core:$koinCore"
            const val test = "io.insert-koin:koin-test:$koinCore"
            const val testJUnit4 = "io.insert-koin:koin-test-junit4:$koinCore"
            const val android = "io.insert-koin:koin-android:$koinAndroid"
            const val compose = "io.insert-koin:koin-androidx-compose:$koinAndroidCompose"
        }
